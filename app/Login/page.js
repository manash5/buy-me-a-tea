...
const page = () => {
  return (
    <div className='text-white py-14 container mx-auto'>
      <h1 className='text-3l font-bold text-center'>Login/Signup to get your fans to support you </h1>
      
        <div className="social-login-buttons flex justify-center my-10">
